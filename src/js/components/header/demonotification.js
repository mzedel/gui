...
const DemoNotification = ({ docsVersion }) => (
  <div id="demoBox" className="flexbox centered">
    ...
    <ReactTooltip id="demo-mode" globalEventOff="click" place="bottom" type="light" effect="solid" className="react-tooltip">
      ...
      <p>
        <a href={`https://docs.mender.io/${docsVersion ? `${docsVersion}/` : 'development/'}administration/production-installation`} target="_blank">
